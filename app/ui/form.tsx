...
export default function Form({ submitAction, textareaRef, prompt, setPromptAction }: {
  ...
  return (
      <form onSubmit={submitAction} className="flex flex-col content-center items-center">
        <div className="flex flex-row w-2/3 bg-[#e0e0e0] p-2 rounded-3xl backdrop-blur-2xl shadow-[4px_4px_8px_#666666,-4px_-4px_6px_#ffffff] hover:shadow-none hover:inset-shadow-[-4px_-4px_8px_#666666,4px_4px_6px_#ffffff] transition duration-300 ease-in-out">
          <textarea
              id="prompt"
              name="prompt"
              ref={textareaRef}
